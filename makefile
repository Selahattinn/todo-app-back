...
mysql-test-build:
	mysql -u root -e 'create database todos;'
	mysql -u root -e 'drop database todos;'
	./bin/todo-app-back
	mysql -u root -e 'use todos;insert into jobs (body) values("Test");insert into jobs (body) values("Test");select * from jobs'
