...
mysql-test-build:
	mysql -u root -p -e 'create database todos;'
	mysql -u root -p -e 'drop database todos;'
	./bin/todo-app-back
	mysql -u root -p -e 'use todos;insert into jobs (body) values("Test");insert into jobs (body) values("Test");select * from jobs'
